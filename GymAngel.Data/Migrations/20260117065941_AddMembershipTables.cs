        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MembershipTransactions_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MembershipTransactions_MembershipPlans_MembershipPlanId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MembershipTransactions_MembershipPlanId",
                table: "MembershipTransactions",
                column: "MembershipPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_MembershipTransactions_UserId",
                table: "MembershipTransactions",
                column: "UserId");
        }
